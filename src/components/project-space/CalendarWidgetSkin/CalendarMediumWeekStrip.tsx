...
export const CalendarMediumWeekStrip = ({
  ...
  return (
    <section className="flex min-h-0 flex-1 flex-col gap-3" aria-label="Week overview">
      ...
      <div className="widget-sheet flex min-h-0 flex-1 flex-col p-3">
        {selectedDay ? (
          <>
            ...
            <div className="widget-rule min-h-0 flex-1 overflow-y-auto pt-3">
              {selectedDay.events.length === 0 ? (
                <div className="widget-dropzone flex h-full min-h-24 items-center justify-center px-3 text-center">
