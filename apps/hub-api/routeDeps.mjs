export const buildRouteDeps = ({ db, stmts, withTransaction, ...deps }) => ({
  ...
  deletePendingInviteProjectsStmt: stmts.spaceMembers.deleteInviteProjects,
  deleteSpaceMemberProjectAccessStmt: stmts.spaceMembers.deleteProjectAccessForUser,
  listSpaceMemberProjectAccessStmt: stmts.spaceMembers.listProjectAccessForUser,
  participantsByRecordStmt: stmts.calendar.listParticipants,
  pendingInviteByIdStmt: stmts.spaceMembers.findInvite,
  pendingInviteProjectIdsStmt: stmts.spaceMembers.listInviteProjectIds,
  ...
  countOtherPersonalSpacesForOwnerStmt: stmts.spaces.countOtherPersonalSpacesForOwner,
  ...
  previousProjectMembershipStmt: stmts.spaceMembers.findPreviousMember,
  ...
  scheduleSpaceDeletionStmt: stmts.spaces.scheduleDeletion,
  insertPendingInviteProjectStmt: stmts.spaceMembers.insertInviteProject,
  insertProjectAccessStmt: stmts.spaceMembers.insertProjectAccess,
  insertProjectMemberWithInviteStmt: stmts.spaceMembers.insertWithInvite,
  removeGuestProjectMemberStmt: stmts.spaceMembers.removeGuest,
  expireProjectMemberStmt: stmts.spaceMembers.expireMember,
  expiredProjectMembershipsForUserStmt: stmts.spaceMembers.listExpiredForUser,
  scopedMembersWithoutProjectAccessStmt: stmts.spaceMembers.listScopedMembersWithoutProjectAccess,
  ...
  updateProjectMemberRoleStmt: stmts.spaceMembers.updateRoleAndExpiry,
  ...
  canUserAccessProject: (userId, projectId) => deps.canUserAccessProject(db, userId, projectId),
  canUserAccessSpaceOverview: (userId, spaceId) => deps.canUserAccessSpaceOverview(db, userId, spaceId),
  canUserManageSpaceMembers: (userId, spaceId) => deps.canUserManageSpaceMembers(db, userId, spaceId),
  canUserEditProject: (userId, projectId) => deps.canUserEditProject(db, userId, projectId),
  canUserDeleteSpace: (userId, spaceId) => deps.canUserDeleteSpace(db, userId, spaceId),
  canUserManageProjectVisibility: (userId, spaceId) => deps.canUserManageProjectVisibility(db, userId, spaceId),
